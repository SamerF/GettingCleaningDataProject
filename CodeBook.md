...
see Feature Selection section below for more details about what each variable mean. 
note that the Feature Selection section is a copy of the information in features_info.txt.
